...
public final class DateUtils {
     ...
     */
    public static final long DAY_MILLI = 24L * 60 * 60 * 1000;
    /**
     * the milli seconds of an hour
     */
    public static final long HOUR_MILLI = 60L * 60 * 1000;
    /**
     * the milli seconds of a minute
     */
    public static final long MINUTE_MILLI = 60L * 1000;
    /**
    ...
    public static int getAbsDateDiffMonth(String date1, String date2) {
        ...
        Period periodToNextJavaRelease =
                Period.between(localDate1, LocalDate.parse(date2, DateTimeFormatter.ofPattern("yyyyMMdd")));
...
//        LocalDateTime year = DateUtils.addTime(LocalDateTime.now(), ChronoUnit.YEARS, -1);
//        System.out.println(DateUtils.formatLocalDateTimeToString(year, "yyyyMM00"));
//
//        LocalDate java8Release = LocalDate.parse("20170701", DateTimeFormatter.ofPattern("yyyyMMdd"));
//        Period periodToNextJavaRelease =
//                Period.between(LocalDate.parse("20180601", DateTimeFormatter.ofPattern("yyyyMMdd")), java8Release);
//        System.out.println("Months left between today and Java 8 release : " + periodToNextJavaRelease.getMonths());
//        
//        
//        int size = 12;
//        List<String> timeline = new ArrayList<>(size);
//        for (int i = 0; i < size; i++) {
//            timeline.add(DateUtils.formatLocalDateTimeToString(
//                    DateUtils.addTime(LocalDateTime.now(), ChronoUnit.MONTHS, (i - 11)), "yyyyMM"));
//
//        }
//        
